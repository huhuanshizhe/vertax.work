...
import { NavAuthActions } from '@/components/marketing/nav-auth-actions';
    ...
    >
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-4 sm:px-6">
        ...
        <div className="hidden items-center gap-7 text-sm md:flex" style={{ color: colors.text.secondary }}>
          ...
          <Link className="transition-colors hover:text-[#0F172A]" href="/plans">
            购买
          </Link>
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          {showEnLink ? (
            <Link
              className="hidden items-center gap-1.5 rounded-full px-3 py-1.5 text-sm transition-colors lg:flex"
              href="/en"
          ...
          <NavAuthActions />
          <Link
            className="hidden rounded-full px-4 py-2 text-sm font-semibold transition-all hover:-translate-y-0.5 md:inline-flex"
            href="/diagnose"
            style={{
              background: colors.brand.gradient,
              boxShadow: shadows.glow,
      ...
      {mobileMenuOpen ? (
        <div className="border-t px-4 py-4 md:hidden" style={{ background: colors.bg.secondary, borderColor: colors.border.light }}>
          <div className="space-y-1">
            ...
            <div className="my-2 border-t" style={{ borderColor: colors.border.light }} />
            <NavAuthActions compact onNavigate={() => setMobileMenuOpen(false)} />
            {showEnLink ? (
              <Link
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <div className="space-y-3 text-sm">
            ...
            <Link className="block" href="/plans" style={{ color: colors.text.secondary }}>
              购买授权
            </Link>
          </div>
